  ...
  return (
    <div className="min-h-screen bg-[#041018] flex flex-col relative">
      ...
      <div className="flex-1 flex">
        <div className="w-full lg:w-[40%] flex flex-col justify-center lg:justify-start lg:px-12 px-6 pt-4 lg:pt-[4.9rem] mt-5 text-left">
          {isLoading ? (
            <>
              <div className="mb-6">
            ...
            <>
              ...
              <p className="hidden lg:block text-[#ffffff69] text-center mt-[3.6rem] text-sm">
