...
const ChatPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#041018] flex">
      <div className="w-full lg:w-[55%] flex flex-col border-r border-[#0021214d] h-screen">
        <nav className="bg-[#041018] sticky  z-50 w-full px-8 py-4 flex items-center justify-between ">
          <h1 className="text-3xl font-bold text-white">
            group<span className=" text-[#4aa6a4]">ups</span>
          </h1>

          <button className="flex items-center gap-2 px-3 py-2 bg-[#191919] rounded-full border border-1 border-[#696969] transition-colors">
